package com.silvercraft.gui.info_book;
...
public class GuiBook extends GuiScreen{
    ...
    public void drawScreen(int parWidth, int parHeight, float p_73863_3_)
    {
        ...
        try{
        	...
        	System.out.println("Ошибка: "+e);
        	System.out.println("Число текстур: "+bookPageTextures.length);
        	System.out.println("Текстура: "+bookPageTextures[currPage].toString());
        	System.out.println("---------------------------------------\n");
        }
        int offsetFromScreenLeft = (width - bookImageWidth ) / 2;
        ...
        try{
        	...
        	System.out.println("width: "+widthOfString+ "; indicator: "+stringPageIndicator+"\n");
